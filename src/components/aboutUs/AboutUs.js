    ...
    <>
      ...
      <div class="grid sm:grid-cols-4 gap-4">
        <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0 ">
          <div className="py-10 text-left lg:flex lg:flex-col lg:justify-left lg:py-16">
            <div className="mx-auto max-w-xs">
              ...
              <p className="mt-6 flex items-baseline justify-left gap-x-2 py-8">
                <h5 className="text-3xl font-bold tracking-tight text-black sm:text-3xl">
                  Web development
                </h5>
              </p>
              <p className="mt-6 text-lg leading-5 text-black">
